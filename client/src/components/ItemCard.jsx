  ...
  return (
    <div className="ItemCard">
      <div className="ItemCard__ImgBlock">
        <img src={props.src} alt="img" className="ItemCard__ImgBlock__Img" />
        <div className="ItemCard__ImgBlock__Sale">-{props.salePercent}%</div>
          ...
          <div className="ItemCard__InfoBlock__PriceBlock">
            <div className="ItemCard__InfoBlock__SalePrice">
              {(
                ...
                (parseInt(props.price) * parseInt(props.salePercent)) / 100
              ).toLocaleString()}
              đ
            </div>
